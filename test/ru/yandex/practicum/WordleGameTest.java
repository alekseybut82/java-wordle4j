...
class WordleGameTest {
    ...
    @Test
    public void testProcessInputWordCorrectGuess() throws Exception {
    ...
    @Test
    public void testProcessInputWordIncorrectGuess() throws Exception {
    ...
    @Test
    public void testCreateHint() throws Exception {
    ...
    @Test
    public void testProcessInputWordInvalidWord() {
        assertThrows(WordNotFoundException.class, () -> game.processInputWord("несущ"));
    }

    @Test
    public void testHintFiltersPreviousAnswers() throws Exception {
    ...
    @Test
    public void testGameOverAfterMaxFailedAttempts() throws Exception {
        for (int i = 0; i < 6; i++) {
    ...
    @Test
    public void testGameWinUsedOnlyHint() throws Exception {
        int i = 1;
        while (!game.isGameOver() ) {
